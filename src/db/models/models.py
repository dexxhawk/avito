...
class BidHistory(Base):
    ...
    author_type = mapped_column(Enum('Organization', 'User', name='bid_author_type'), nullable=False)
...
class Tender(Base):
    ...
    organization: Mapped['Organization'] = relationship('Organization', back_populates='tender')

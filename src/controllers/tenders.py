...
from src.db.models.models import Employee, OrganizationResponsible, Tender, TenderHistory
...
async def rollback(session: AsyncSession, bid_id: str, version: int, username: str):
        ...
        if not tender_history:
            raise HTTPException(status_code=404, detail="Tender with such version not found")
